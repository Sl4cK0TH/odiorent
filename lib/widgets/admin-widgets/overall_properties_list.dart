...
class OverallPropertiesList extends StatefulWidget {
  const OverallPropertiesList({super.key});

  @override
  State<OverallPropertiesList> createState() => _OverallPropertiesListState();
}
...
class _OverallPropertiesListState extends State<OverallPropertiesList> {
  ...
  void initState() {
    super.initState();
    _propertiesFuture = _dbService.getAllPropertiesWithLandlordDetails();
  }
